...
namespace Declaration.Orchestration.Tests
{
    ...
    internal class UnusedDeclarationRepository : IDeclarationRepository
    {
        ...
        public virtual Task<IEnumerable<AffectationDetailRow>> GetAffectationDetailsRapprochementAsync(int soId, IEnumerable<string> mvNumeros) => Task.FromResult<IEnumerable<AffectationDetailRow>>(Array.Empty<AffectationDetailRow>());
        ...
        public Task<Dictionary<int, DateTime?>> GetDernieresDatesRapprochementAsync(int soId, IEnumerable<int> ecIds) => throw NotUsed(); // TASK-135 (stub, non exercé par ces tests)
