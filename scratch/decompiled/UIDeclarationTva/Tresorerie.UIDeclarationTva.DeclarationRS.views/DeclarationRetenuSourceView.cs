...
public class DeclarationRetenuSourceView : IEntity
{
	...
	public TypeEntity TypeEntity => TypeEntity.DeclarationRetenuSource;

	public DeclarationRetenuSourceView()
	{
		Date = DateTime.Now;
		Guid = Guid.NewGuid();
	}
	...
	public override bool Equals(object obj)
	{
		...
		if (!(obj is DeclarationRetenuSourceView declarationRetenuSourceView))
		{
			return false;
		}
		if (!(declarationRetenuSourceView.Guid == Guid))
		{
			return declarationRetenuSourceView.GetHashCode() == GetHashCode();
		}
		return true;
	}
