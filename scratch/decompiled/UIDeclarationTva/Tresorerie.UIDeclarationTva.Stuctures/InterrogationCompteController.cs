...
public class InterrogationCompteController
{
	...
	public InterrogationCompteController(ILicenceApplicationVersion licenceApplicationVersion, IErpComptaService erpComptaService, IGroupeService groupeService, DeviseViewHelper deviseViewHelper)
	{
	...
	public List<IErpComptaEcritureComptable> GetGrandLivre(DateTime dateDebut, DateTime dateFin, bool inclureRan)
	{
		return _erpComptaService.GetGrandLivre(dateDebut, dateFin, inclureRan).ToList();
	}
}
