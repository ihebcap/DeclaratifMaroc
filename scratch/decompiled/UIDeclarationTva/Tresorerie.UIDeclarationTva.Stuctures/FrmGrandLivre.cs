...
public class FrmGrandLivre : RibbonForm, IGridViewForm
{
	private readonly GrandLivreController _controller;
	...
	public FrmGrandLivre(GrandLivreController controller)
		: this()
	{
	...
	private void Actualiser(object sender = null, EventArgs e = null)
	{
		...
		try
		{
			...
			gcGrandLivre.DataSource = _controller.GetGrandLivre(txtDateDu.DateTime.Date, txtDateAu.DateTime.Date);
		}
		catch (Exception ex)
		{
	...
	private void InitializeComponent()
	{
		...
		this.Root.Items.AddRange(new DevExpress.XtraLayout.BaseLayoutItem[5] { this.emptySpaceItem2, this.layoutControlItem3, this.layoutControlItem5, this.layoutControlItem6, this.layoutControlItem4 });
		this.Root.Name = "Root";
