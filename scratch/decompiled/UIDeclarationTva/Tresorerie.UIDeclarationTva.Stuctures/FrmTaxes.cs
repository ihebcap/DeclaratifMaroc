...
public class FrmTaxes : RibbonForm, IGridViewForm
{
	private readonly TauxTaxeController _controller;
	...
	public FrmTaxes(TauxTaxeController controller)
		: this()
	{
	...
	private void InitGrid()
	{
		...
		{
			Caption = "Assujettissement",
			FieldName = "Assujettissement",
			Visible = true
		};
		...
		gv.Columns.AddRange(new GridColumn[9] { gridColumn, gridColumn2, gridColumn3, gridColumn4, gridColumn5, gridColumn7, gridColumn6, gridColumn8, gridColumn9 });
		gv.Init();
		...
		gv.Tag = new Guid("{5FB37FC9-1A94-4D8A-A477-E99D4B819EAC}");
	}
}
