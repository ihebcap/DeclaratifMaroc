...
public class FrmJournaux : RibbonForm, IGridViewForm
{
	private readonly JournauxController _controller;
	...
	public FrmJournaux(JournauxController controller)
		: this()
	{
	...
	private void InitGrid()
	{
		...
		{
			Caption = "Rapprochement sur",
			FieldName = "Rapprochement",
			Visible = true
		};
		gv.Columns.AddRange(new GridColumn[5] { gridColumn, gridColumn2, gridColumn3, gridColumn5, gridColumn4 });
		gv.Init();
