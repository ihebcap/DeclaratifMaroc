...
public class FrmListeDeclarationRetenuSource : RibbonForm, IGridViewForm, IDeclarationRetenuSourceNotify
{
	...
	private List<DeclarationRetenuSourceView> _declarationCollection;
	...
	private FrmListeDeclarationRetenuSource()
	{
		InitializeComponent();
	...
	public FrmListeDeclarationRetenuSource(ListDeclarationRetenuSourceController controller)
		: this()
	{
	...
	private void AjouterDeclaration(object sender, EventArgs e)
	{
		...
		DeclarationRetenuSourceView view = _controller.InitView();
		((IParentFormDeclarationRetenuSource)base.MdiParent).OpenDeclarationRetenuSource(view);
	}

	private void DeleteDeclaration(object sender, EventArgs e)
	{
		if (!(gv.GetFocusedRow() is DeclarationRetenuSourceView view))
		{
			return;
		}
	...
	{
		_controller.HasRestrictionAjout();
		if (e.Button == MouseButtons.Left && e.Clicks == 2 && gv.GetFocusedRow() is DeclarationRetenuSourceView view && base.MdiParent is IParentFormDeclarationRetenuSource parentFormDeclarationRetenuSource)
		{
			parentFormDeclarationRetenuSource.OpenDeclarationRetenuSource(view);
		}
	}
	...
	public void DeclarationRetenuSourceChanged(DeclarationRetenuSourceChangedArgs e)
	{
		...
		case TypeAction.Ajout:
		{
			...
			{
				NotifyDeclarationRetenuSourceChangedAjout(e);
			};
			BeginInvoke(method3);
			break;
		}
		case TypeAction.Suppression:
		{
			...
			{
				NotifyDeclarationRetenuSourceChangedSupp(e);
			};
			BeginInvoke(method2);
			break;
		}
		case TypeAction.Modification:
		{
			...
			{
				NotifyDeclarationRetenuSourceChangedModify(e);
			};
			BeginInvoke(method);
			break;
		}
	...
	private void NotifyDeclarationRetenuSourceChangedAjout(DeclarationRetenuSourceChangedArgs e)
	{
		DeclarationRetenuSourceView declarationRetenuSourceView = _controller.Get(e.EntityNo);
		if (declarationRetenuSourceView != null)
		{
			_declarationCollection.Add(declarationRetenuSourceView);
			GridviewSelectionChanged(null, null);
			_pLinqEntet.Refresh();
		}
	}

	private void NotifyDeclarationRetenuSourceChangedModify(DeclarationRetenuSourceChangedArgs e)
	{
		DeclarationRetenuSourceView declarationRetenuSourceView = _declarationCollection.SingleOrDefault((DeclarationRetenuSourceView x) => x.No == e.EntityNo);
		if (declarationRetenuSourceView == null)
		{
			return;
		}
		DeclarationRetenuSourceView declarationRetenuSourceView2 = _controller.Get(e.EntityNo);
		if (declarationRetenuSourceView2 == null)
		{
			return;
		}
		int num = _declarationCollection.IndexOf(declarationRetenuSourceView);
		if (num < 0)
		{
			return;
		}
		...
		try
		{
			_declarationCollection[num] = declarationRetenuSourceView2;
			GridviewSelectionChanged(null, null);
			_pLinqEntet.Refresh();
		}
		catch (Exception ex)
	...
	private void NotifyDeclarationRetenuSourceChangedSupp(DeclarationRetenuSourceChangedArgs e)
	{
		DeclarationRetenuSourceView declarationRetenuSourceView = _declarationCollection.SingleOrDefault((DeclarationRetenuSourceView x) => x.No == e.EntityNo);
		if (declarationRetenuSourceView != null)
		{
			_declarationCollection.Remove(declarationRetenuSourceView);
			GridviewSelectionChanged(null, null);
			_pLinqEntet.Refresh();
		}
	}
	...
	private void InitializeComponent()
	{
		...
		this.ribbon.Size = new System.Drawing.Size(995, 162);
		...
		this.gc.Name = "gc";
		this.gc.Size = new System.Drawing.Size(991, 422);
		this.gc.TabIndex = 1;
		...
		this.layoutControl1.Size = new System.Drawing.Size(995, 466);
		this.layoutControl1.TabIndex = 3;
		this.layoutControl1.Text = "layoutControl1";
		this.btnSupprimer.ImageOptions.Image = Tresorerie.UIDeclarationTva.Properties.Resources.new_delete_32;
		this.btnSupprimer.Location = new System.Drawing.Point(877, 2);
		...
		this.btnAjouter.Location = new System.Drawing.Point(757, 2);
		...
		this.Root.Size = new System.Drawing.Size(995, 466);
		...
		this.layoutControlItem1.Size = new System.Drawing.Size(995, 426);
		...
		base.ClientSize = new System.Drawing.Size(995, 628);
		base.Controls.Add(this.layoutControl1);
		base.Controls.Add(this.ribbon);
		base.Name = "FrmListeDeclarationRetenuSource";
		this.Ribbon = this.ribbon;
		this.Text = "Déclarations RAS";
