# TASK-093 — Renommer le nom de module sur la page d'authentification (« Déclaratif Maroc »)

> Renumérotée 082 → 093 à l'archivage (14/07/2026) : le n° 082 était déjà pris par une autre tâche livrée (bandeau incohérence ligne `Exclue`, cf. DONE.md). Aucun impact code.
...
- `VERIFY/TASK-093_verify.md` : capture de l'écran de connexion montrant le nouveau titre + capture de l'onglet navigateur montrant le nouveau `<title>`, sortie build front sans erreur.
